...
// AICI AM ADĂUGAT 'Cpu' și 'Wifi' CARE LIPSEAU
    ...
    <section id="ai" className="py-24 relative bg-[#01030c] overflow-hidden min-h-[950px] flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
                 {/* HEADER FUTURIST */}
                <div className="inline-flex items-center gap-3 px-8 py-3 rounded-2xl border border-cyan-500/30 bg-cyan-950/30 backdrop-blur-xl text-cyan-300 text-sm font-bold tracking-[0.3em] mb-8 uppercase shadow-[0_0_30px_rgba(6,182,212,0.2)] relative overflow-hidden">
