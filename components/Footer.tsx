        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li><Link href="/academie" className="hover:text-white transition-colors">Academia Crypto</Link></li>
              <li><Link href="/stiri" className="hover:text-white transition-colors">Știri & Analize</Link></li>
              <li><Link href="/#consultanta" className="hover:text-yellow-400 transition-colors font-bold">VIP Mentorship</Link></li>
            </ul>
          </div>
