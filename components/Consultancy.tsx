                ...
                <div className="flex-1 space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-[#1a1500] to-black border border-yellow-500/30 p-6 rounded-2xl relative group hover:border-yellow-500/60 transition-colors">
                        ...
                        <h3 className="font-bold text-lg text-white mb-4 flex items-center gap-2">
                            <Zap size={18} className="text-yellow-500"/> Pachet Investitor Premium
                        </h3>
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                <FileText size={18} className="text-yellow-600 mt-0.5"/>
                                <div className="text-sm">
                                    <span className="text-white font-bold">PDF: Audit ca un VC</span> — Framework de analiză profesională.
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <BookOpen size={18} className="text-yellow-600 mt-0.5"/>
                                <div className="text-sm">
                                    <span className="text-white font-bold">PDF: Ghid Investitor Avansat</span> — 20 pagini de strategie aplicată.
                                </div>
                            </li>
                        </ul>
                    </div>
